//@ sourceMappingURL=mockupgo\app\assets\javascripts\angular\mockupgo\app\assets\javascripts\angular\directives.map
      ...
      return function(scope, element, attrs) {
        return $(element).selectable({
          start: function(event) {
            ...
            $('div.note-new').remove();
            return $rootScope.interactivity.start_realtime_update_for_create(scope.notes, scope.newnote, event);
          },
          stop: function(event) {
            ...
            $rootScope.interactivity.activate_note(scope.notes, $('.note-new'));
